                ...
                <div class="bg-white border border-blue-300 rounded-xl p-4 shadow-sm flex flex-col h-full">
                    ...
                    <nav class="flex-1">
                        <ul class="space-y-3">
                            ...
                            <li class="bg-red-50 rounded-lg"><a href="userpage.php" class="flex items-center gap-3 px-2 py-2 rounded-lg text-primary"><span class="w-9 h-9 flex items-center justify-center rounded-md bg-white border text-primary">👤</span><span class="text-sm font-medium">Profile</span></a></li>
